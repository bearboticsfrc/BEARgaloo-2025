...
public class MotorConfig {
   ...
   */
  private MotorConfig configureMotor() {
  ...
  public MotorConfig configurePID(MotorPIDBuilder motorPid) {
    ...
    if (positionPidWrappingEnabled) {
      config
          .closedLoop
          .positionWrappingEnabled(positionPidWrappingEnabled)
          .positionWrappingInputRange(
              motorPid.getPositionPidWrappingMin(), motorPid.getPositionPidWrappingMax());
    }
  ...
  public MotorConfig configurePID(MotorPIDBuilder motorPid, int slot) {
    ...
    config
        .closedLoop
        .p(motorPid.getP(), closedLoopSlot)
